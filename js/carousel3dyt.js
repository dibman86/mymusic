...
function Notification(text, val) {
	let val1 = '';
	const notif = document.querySelector('.notification');
	...
	const creatNotification = '<div class="notification invisiblenotif"><div class="notif-text notif-text1">' + text + '</div><div class="notif-text notif-text2 ' + val1 + '">' + ' ' + val + '</div></div>';
	if(window.isMinimised){
